...
namespace thread_pool
{
   ...
   protected:
         ...
         bool CreateWorker();
         void DestroyWorker(const utils::CScopedThread::ThreadID threadToDestory);
...
/////////////////////////////////////////////////////////////////////////////////////
   void CDynamicPool::DestroyWorker(const utils::CScopedThread::ThreadID IdThreadToDestory)
   {
      if (m_PoolStatus != PoolStatus::Stopped)
		{
         m_TaskQueue.AddElement(
...
/////////////////////////////////////////////////////////////////////////////////////
   ...
   {
      m_PoolStatus = PoolStatus::RunningButDoNotAcceptNewTasks;
   }
/////////////////////////////////////////////////////////////////////////////////////
      ...
      while (m_PoolStatus != PoolStatus::Stopped)
      {
         ...
         if(getResult == CThreadSafeQueue<Task>::WaitResult::GotElement)
         {
            if(taskToExecute)
            {
			   ...
			   if (m_PoolStatus == PoolStatus::RunningButDoNotAcceptNewTasks && m_TaskQueue.Empty())
			   {
				   m_Waiter.notify_all();
			   }
            }
...
//   }
///////////////////////////////////////////////////////////////////////////////////////
//   inline void CDynamicPool::EmergencyStop()
//   {
//       m_PoolStatus = PoolStatus::Stopped;
//       m_TaskQueue.WakeUpAllThreads();
//#ifdef LOG
